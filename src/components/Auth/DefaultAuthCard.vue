...
<template>
  ...
  <div class="">
    <div class="flex flex-wrap items-center">
      <div class="hidden w-full xl:block md:block xl:w-1/2 md:w-1/2">
      ...
      <div
        class="w-full border-stroke dark:border-strokedark xl:w-1/2 md:w-1/2 xl:border-l-2 md:border-l-2"
      >
